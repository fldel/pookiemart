<nav x-data="{ open: false }" class="w-full bg-white border-b border-gray-100 shadow">
    <div class="flex items-center justify-between h-20 px-6">
        ...
        <div class="flex-1 px-10">
            <div class="relative max-w-2xl mx-auto">
                <input type="text" placeholder="Search something"
                    class="w-full px-4 py-2 text-sm border border-gray-300 rounded-full focus:border-brand-default focus:ring-1 focus:ring-brand-default focus:ring-offset-0">
                <button class="absolute top-0 right-0 flex items-center h-full px-3 text-gray-500">
        ...
        <div class="flex items-center space-x-8">
            {{-- Order --}}
            <a href="#" class="text-gray-600 hover:text-brand-default">
